...
In case it helps, here's a commit that includes all the code we'll go over in today's class: <https://codeberg.org/cjones/csc221/commit/07ec5a9fbad7ae080cf6f1574c232eee804c08ca>.
