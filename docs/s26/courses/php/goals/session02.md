...
that you've memorized the minimal HTML page.
...
We'll briefly discuss the three languages that make up a website: HTML, CSS,
and Javascript. We'll be focusing on HTML for now, but I want you to understand
what HTML does, and what it leaves to CSS/Javascript.
...
On our [edube.org](https://edube.org/) class, read the first three pages in
Module 2:
