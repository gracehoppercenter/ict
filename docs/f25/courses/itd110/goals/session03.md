...
As always, we'll start this class with a short, simple quiz. See the previous day's lesson page for details about what to expect on this quiz.
...
Just like today's class, I'll start the next class with a quiz where you will demonstrate that you know how to use these commands.