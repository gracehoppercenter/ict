...
### Quiz
We'll start class with a short quiz on conversions to and from hexadecimal, and last class's reading.
...
- [Spongebob](https://www.youtube.com/watch?v=6K1pcOfrTXc) <-- Thanks to Maddie in our 5th period class for giving us this awesome example of an Adversary in the Middle attack =)
