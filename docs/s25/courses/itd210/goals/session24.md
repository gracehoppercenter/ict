...
### Warmup Activity  
Review our work from before break. If you need, spend the first few minutes of class
completing last class's assignment. If you already completed it, add some extra
shapes to make your scene more interesting.

I'll count this as a graded classwork assignment, so be sure to commit and link
to your code from your website.
